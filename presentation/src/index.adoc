...
image::spring-boot-logo.png[Spring Boot Demo,width=200]
...
String jwt = Jwts.builder()
    ...
    .compact();
----
// todo: why isn't this color coded?
...
video::QSYK4OCmycI[youtube]

[.m-lg]
By https://twitter.com/afitnerd[Micah Silverman]
